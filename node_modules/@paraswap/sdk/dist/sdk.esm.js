...
function deriveCompactSignature(signature) {
...
var _excluded$8 = ["tokenType", "mainConnector", "connectors", "network"];
var constructToken = function constructToken(tokenProps) {
  var _tokenProps$tokenType = tokenProps.tokenType,
    ...
    rest = _objectWithoutPropertiesLoose(tokenProps, _excluded$8);
...
function normalizeRateOptions(_ref) {
  var _ref$options = _ref.options,
    ...
    restInput = _objectWithoutPropertiesLoose(_ref, _excluded$7);
...
var _excluded$6 = ["srcToken", "destToken"],
  _excluded2$3 = ["route"];
  ...
  var getRate = /*#__PURE__*/function () {
    var _ref3 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(_ref2, signal) {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            srcToken = _ref2.srcToken, destToken = _ref2.destToken, rest = _objectWithoutPropertiesLoose(_ref2, _excluded$6);
...
var _excluded$5 = ["srcToken", "destToken", "amount", "route"];
  ...
  var getSwapTxData = /*#__PURE__*/function () {
    var _ref3 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(_ref2, signal) {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            srcToken = _ref2.srcToken, destToken = _ref2.destToken, amount = _ref2.amount, route = _ref2.route, rest = _objectWithoutPropertiesLoose(_ref2, _excluded$5);
            parsedOptions = normalizeRateOptions(rest);
...
function constructFillOrderDirectly(options) {
  ...
  var fillOrderDirectly = /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(_ref, overrides, signal) {
...
var constructApproveTokenForNFTOrder = function constructApproveTokenForNFTOrder(options) {
  ...
  var approveNFTForNFTOrder = /*#__PURE__*/function () {
    ...
    return function approveNFTForNFTOrder(_x, _x2) {
      return _ref.apply(this, arguments);
    };
  }();
  return {
...
var constructGetPartnerFee = function constructGetPartnerFee(_ref) {
  ...
  var getPartnerFee = /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(options, signal) {
...
function buildDeltaSignableOrderData(_ref2) {
  var owner = _ref2.owner,
    ...
    partnerFee = _ref2.partnerFee,
    takeSurplus = _ref2.takeSurplus,
...
function producePartnerAndFee(_ref3) {
  var partnerFee = _ref3.partnerFee,
    partnerAddress = _ref3.partnerAddress,
    takeSurplus = _ref3.takeSurplus;
  if (partnerAddress === ZERO_ADDRESS) return '0';
  var partnerFeeBps = BigInt((partnerFee * 100).toFixed(0));
  var partnerAndFee = BigInt(partnerAddress) << BigInt(96) | partnerFeeBps | BigInt(takeSurplus) << BigInt(8);
...
var constructBuildDeltaOrder = function constructBuildDeltaOrder(options) {
  ...
  var buildDeltaOrder = /*#__PURE__*/function () {
    var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(options, signal) {
      var _options$partnerFee, _options$nonce;
      var ParaswapDelta, partnerAddress, partnerFee, takeSurplus, _partnerAddress, _partnerFee, _takeSurplus, partner, partnerFeeResponse, input;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return getDeltaContract(signal);
          case 2:
          ...
          case 5:
            ...
            partnerFee = (_options$partnerFee = options.partnerFee) != null ? _options$partnerFee : options.deltaPrice.partnerFee;
            takeSurplus = options.takeSurplus;
            if (!(partnerAddress === undefined || partnerFee === undefined || takeSurplus === undefined)) {
              _context.next = 16;
              break;
            }
          ...
          case 12:
            ...
            partnerFee = (_partnerFee = partnerFee) != null ? _partnerFee : partnerFeeResponse.partnerFee;
            takeSurplus = (_takeSurplus = takeSurplus) != null ? _takeSurplus : partnerFeeResponse.takeSurplus;
          case 16:
            input = {
              owner: options.owner,
...
var constructPostDeltaOrder = function constructPostDeltaOrder(_ref) {
  ...
  var postDeltaOrder = function postDeltaOrder(postData, signal) {
    ...
    var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(typedData) {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          ...
          case 6:
            _context.prev = 6;
            return _context.abrupt("return", deriveCompactSignature(signature));
          case 10:
            _context.prev = 10;
...
var constructGetDeltaPrice = function constructGetDeltaPrice(_ref) {
  ...
  var getDeltaPrice = /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(options, signal) {
      var search, fetchURL, data;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
    ...
    return function getDeltaPrice(_x, _x2) {
      return _ref2.apply(this, arguments);
    };
  }();
  return {
...
var constructGetDeltaOrders = function constructGetDeltaOrders(_ref) {
  ...
  var getDeltaOrderById = /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(orderId, signal) {
      var fetchURL, order;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
  ...
  var getDeltaOrders = /*#__PURE__*/function () {
    var _ref3 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(options, signal) {
      ...
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          ...
          case 4:
            ...
            return _context2.abrupt("return", orders);
          case 6:
          case "end":
            return _context2.stop();
        }
    ...
    return function getDeltaOrders(_x3, _x4) {
      return _ref3.apply(this, arguments);
    };
  }();
  return {
...
var constructApproveTokenForDelta = function constructApproveTokenForDelta(options) {
  ...
  var getParaswapDelta = /*#__PURE__*/function () {
    ...
    return function getParaswapDelta() {
      return _ref.apply(this, arguments);
    };
  }();
...
var constructGetQuote = function constructGetQuote(_ref) {
  ...
  function _getQuote() {
    _getQuote = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(options, signal) {
      var search, fetchURL, data;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
...
var constructAllDeltaOrdersHandlers = function constructAllDeltaOrdersHandlers(options) {
  ...
  return _extends({}, deltaOrdersGetters, deltaOrdersContractGetter, deltaPrice, partnerFee, approveTokenForDelta, deltaOrdersSubmit, deltaOrdersBuild, deltaOrdersSign, deltaOrdersPost);
};
...
function constructSimpleSDK(options, providerOptions) {
  ...
  if (!providerOptions) {
    ...
    var _delta = constructPartialSDK(_config, constructBuildDeltaOrder, constructPostDeltaOrder, constructGetDeltaOrders, constructGetDeltaPrice, constructGetDeltaContract, constructGetPartnerFee);
