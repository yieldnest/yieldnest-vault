...
contract Strategy is IVault, ERC20PermitUpgradeable, AccessControlUpgradeable, ReentrancyGuardUpgradeable {
     ...
     */
    function _mintSharesForNative(uint256 amount, address sender) private onlyRole(ALLOCATOR_ROLE) {
        if (paused()) {
            revert Paused();
        }
