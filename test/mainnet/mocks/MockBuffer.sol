...
contract MockBuffer is ERC20 {
    ...
    function deposit(uint256 assets, address receiver) public returns (uint256) {
        ...
        _totalAssets += assets;
        IERC20(MainnetContracts.USDC).transferFrom(msg.sender, address(this), assets);
    ...
    function withdraw(uint256 assets, address receiver, address owner) public returns (uint256) {
        ...
        IERC20(MainnetContracts.USDC).transferFrom(address(this), receiver, assets);
        _burn(owner, assets);
    ...
    function redeem(uint256 shares, address receiver, address owner) public returns (uint256) {
        ...
        IERC20(MainnetContracts.USDC).transferFrom(address(this), owner, bufferAssets);
